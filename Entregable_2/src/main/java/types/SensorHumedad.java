...
public class SensorHumedad {
	...
	public Integer getSensorhumedad_id() {
		return id_SensorHumedad;
	}
	public void setSensorhumedad_id(Integer id_SensorHumedad) {
		this.id_SensorHumedad = id_SensorHumedad;
	}
	public Integer getPlaca_id() {
		return id_Placa;
	}
	public void setPlaca_id(Integer id_Placa) {
